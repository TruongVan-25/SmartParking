<?php function paging($page_, $posts_per_page_, $request_key = 'page')
{
	...
	<?php } else { ?>
		...
		<li class="page-item"><a href="?<?php echo $query_string; ?>&<?php echo $request_key ?>=1"
				class="page-link">&laquo;&laquo;</a></li>
		<li class="page-item"><a href="?<?php echo $query_string; ?>&<?php echo $request_key ?>=<?php echo $page_ - 1; ?>"
				class="page-link page-separator-left">&laquo;</a></li>

	<?php }

	for ($i = $start_page; $i <= $end_page; $i++) { ?>

		<li class="page-item <?php if ($i == $page_)
			echo "active"; ?>"><a <?php if ($i != $page_)
				  echo 'href="?' . $request_key . '=' . $i . '"'; ?>
				class="page-link <?php if ($i == $page_)
					echo "active"; ?>"><?php echo $i; ?><?php if ($i == $page_)
	...
	<?php } else { ?>
		...
		<li class="page-item"><a href="?<?php echo $query_string; ?>&<?php echo $request_key ?>=<?php echo $page_ + 1; ?>"
				class="page-link page-separator-right">&raquo;</a></li>
		<li class="page-item"><a href="?<?php echo $query_string; ?>&<?php echo $request_key ?>=<?php echo $end_page; ?>"
				class="page-link">&raquo;&raquo;</a></li>

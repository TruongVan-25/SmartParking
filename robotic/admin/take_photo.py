...
ap.add_argument("-s", "--source", type=int, default=0, help="choose the video source")
args = vars(ap.parse_args())

# Create a VideoCapture object

#cap = cv2.VideoCapture("http://192.168.1.111:8000/stream.mjpg")
#cap = cv2.VideoCapture("http://172.16.10.21:8000/stream.mjpg")



if (args["source"] == 1):
	print("[INFO] Start taking photo with detection...")
	cap = cv2.VideoCapture("http://192.168.1.200/html/")	
else:

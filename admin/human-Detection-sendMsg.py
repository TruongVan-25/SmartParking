...
#vs = cv2.VideoCapture("http://192.168.1.211:8000/stream.mjpg")
if not (vs.isOpened()):
...
while True:
	...
	cv2.putText(frame, "DATE: {}".format(date2), (20,20), cv2.FONT_HERSHEY_DUPLEX, 0.8,(255,0,0))			
	...
	# if key == ord("q"):
	if key == 27 or key == ord('q') or frame_number == 100:
		break
...
print("[INFO] Human detection end!")

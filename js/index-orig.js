...
$(document).ready(function() {
    ...
    $("#robot_forward").mousedown(function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "http://192.168.1.211/admin/robot/forward.php",
        ...
        $.ajax({
            type: "GET",
            url: "http://192.168.1.211/admin/robot/stop.php",
            success: function(result) {
                alert('Stop!');
            },
            error: function(result) {
    ...
    $("#robot_left").mousedown(function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "http://192.168.1.211/admin/robot/left.php",
            success: function(result) {
                alert('Turn left!');
            },
            error: function(result) {
    ...
    $("#robot_right").mousedown(function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "http://192.168.1.211/admin/robot/right.php",
            success: function(result) {
                alert('Turn right!');
            },
            error: function(result) {
    ...
    $("#robot_back").mousedown(function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "http://192.168.1.211/admin/robot/back.php",
            success: function(result) {
                alert('Turn back!');
            },
            error: function(result) {
...
//Camera Control
    ...
    $("#camera_up").click(function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "http://192.168.1.211/admin/robot/camera_up.php",            
            success: function(result){
                alert('add data ok!');
            },           
            error: function(result) {
    ...
    $("#camera_down").click(function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "http://192.168.1.211/admin/robot/camera_down.php",
            success: function(result) {
                alert('Turn left!');
            },
            error: function(result) {
    ...
    $("#camera_right").click(function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "http://192.168.1.211/admin/robot/camera_left.php",
            success: function(result) {
                alert('Turn left!');
            },
            error: function(result) {
    ...
    $("#camera_left").click(function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "http://192.168.1.211/admin/robot/camera_right.php",
    ...
    $("#camera_center").click(function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "http://192.168.1.211/admin/robot/camera_center.php",
            success: function(result) {
                alert('Turn right!');
            },
            error: function(result) {
    ...
    $("#buzzer_on").mousedown(function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "http://192.168.1.211/admin/robot/buzzer_on.php",
            success: function(result) {
                //alert('Turn back!');
            },
            error: function(result) {
        ...
        $.ajax({
            type: "GET",
            url: "http://192.168.1.211/admin/robot/buzzer_off.php",
            success: function(result) {
                //alert('Stop!');
            },
            error: function(result) {
    ...
    $("#light_on").click(function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "http://192.168.1.211/admin/robot/light_on.php",            
            success: function(result){
                //alert('add data ok!');
            },           
            error: function(result) {
    ...
    $("#light_off").click(function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "http://192.168.1.211/admin/robot/light_off.php",
            success: function(result) {
                //alert('Turn left!');
            },
            error: function(result) {
    ...
    $("#start_stream_video").click(function(e) {
        ...
        if (r == true) {
            $.ajax({
                type: "GET",
                url: "http://192.168.1.211/admin/start_stream_video.php",
            ...
            setTimeout(() => { document.getElementById("video_feed").src="http://192.168.1.211:8000/stream.mjpg"; }, 5000);
    ...
    $("#stop_stream_video").click(function(e) {
        ...
        if (r == true) {
            $.ajax({
                type: "GET",
                url: "http://192.168.1.211/admin/stop_stream_video.php",
                //url: "http://localhost/smartparking/admin/start_stream_video.php",
                success: function(result) {
    ...
    $("#start_sensor").click(function(e) {
        ...
        if (r == true) {
            $.ajax({
                type: "GET",
                url: "http://192.168.1.211/admin/sensor/start_sensor.php",                
                success: function(result) {
    ...
    $("#stop_sensor").click(function(e) {
        ...
        if (r == true) {
            $.ajax({
                type: "GET",
                url: "http://192.168.1.211/admin/sensor/stop_sensor.php",                
                success: function(result) {
    ...
    $("#stop_detection").click(function(e) {
        ...
        if (r == true) {
            ...
            document.getElementById("video_feed").src="http://192.168.1.211:8000/stream.mjpg";
...
// System control 
    $("#shutdown_pi").click(function(e) {
        ...
        if (r == true) {
            $.ajax({
                type: "GET",
                url: "http://192.168.1.211/admin/shutdown_pi.php",
                //url: "http://localhost/smartparking/admin/start_stream_video.php",
                success: function(result) {
...
// //     window.location = 'http://192.168.1.211/forward.php';
// // }
// // document.getElementById('robot_stop').onclick = function () {
// //     window.location = 'http://192.168.1.211/stop.php';
// // }
